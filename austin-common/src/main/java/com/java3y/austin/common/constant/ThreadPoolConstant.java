...
/**
 * Common constant information for thread pools
 * 线程池常见的常量信息
 * (Only for initialization, thread pool configuration in code may be dynamically modified by Apollo)
 * （仅供初始化的使用，代码里的线程池配置有可能袮apollo动态修改)
 *
 * @author 3y
 */
