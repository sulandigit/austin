...
/**
 * Send channel URL constants, unified maintenance of sending addresses
 * 发送渠道的URL常量，统一维护发送地址
 *
 * @author 3y
 */
public class SendChanelUrlConstant {
    ...
    /**
     * DingTalk work message related URLs
     * 钉钉工作消息相关的url
     */
    ...
    /**
     * Enterprise WeChat robot related URLs
     * 企业微信机器人相关的url
     */
